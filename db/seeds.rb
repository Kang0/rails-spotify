...
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 8, recommend: Faker::Boolean.boolean, user_id: 1, album_id: 3, title: Faker::Lorem.sentence(4), vinyl_id: 1)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 7, recommend: Faker::Boolean.boolean, user_id: 1, album_id: 8, title: Faker::Lorem.sentence(4), vinyl_id: 2)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 6, recommend: Faker::Boolean.boolean, user_id: 1, album_id: 6, title: Faker::Lorem.sentence(4), vinyl_id: 3)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 5, recommend: Faker::Boolean.boolean, user_id: 1, album_id: 1, title: Faker::Lorem.sentence(4), vinyl_id: 4)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 8, recommend: Faker::Boolean.boolean, user_id: 1, album_id: 12, title: Faker::Lorem.sentence(4), vinyl_id: 5)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 6, recommend: Faker::Boolean.boolean, user_id: 2, album_id: 8, title: Faker::Lorem.sentence(4), vinyl_id: 6)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 3, recommend: Faker::Boolean.boolean, user_id: 2, album_id: 4, title: Faker::Lorem.sentence(4), vinyl_id: 7)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 8, recommend: Faker::Boolean.boolean, user_id: 2, album_id: 10, title: Faker::Lorem.sentence(4), vinyl_id: 8)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 9, recommend: Faker::Boolean.boolean, user_id: 2, album_id: 9, title: Faker::Lorem.sentence(4), vinyl_id: 9)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 2, recommend: Faker::Boolean.boolean, user_id: 2, album_id: 6, title: Faker::Lorem.sentence(4), vinyl_id: 10)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 1, recommend: Faker::Boolean.boolean, user_id: 3, album_id: 2, title: Faker::Lorem.sentence(4), vinyl_id: 11)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 3, recommend: Faker::Boolean.boolean, user_id: 3, album_id: 3, title: Faker::Lorem.sentence(4), vinyl_id: 12)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 7, recommend: Faker::Boolean.boolean, user_id: 3, album_id: 5, title: Faker::Lorem.sentence(4), vinyl_id: 13)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 7, recommend: Faker::Boolean.boolean, user_id: 3, album_id: 11, title: Faker::Lorem.sentence(4), vinyl_id: 14)
Review.create(content: Faker::Lorem.paragraph(10, false, 0), rating: 5, recommend: Faker::Boolean.boolean, user_id: 3, album_id: 7, title: Faker::Lorem.sentence(4), vinyl_id: 15)
